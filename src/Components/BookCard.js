...
import deleteBook from '../Redux/AddBook/Thunk/deleteBook';
        ...
        <div class="book-card">
            ...
            <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
                <div class="flex items-center justify-between">
                    {book.featured ?
                        <span class="badge-success lws-Badge"> featured </span> : <span></span>}
                    <div class="text-gray-500 space-x-2">
                        <button class="lws-edit" onClick={() => dispatch(getEditId(book.id))}>
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                            </svg>
                        </button>
                        <button class="lws-delete" onClick={() => deleteBookHandler(book.id)}>
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
